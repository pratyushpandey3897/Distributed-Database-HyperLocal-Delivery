...
if __name__ == '__main__':
    ...
    try:
        ...
        unoptimized_reserve_order_items(conn.cursor(), 1, [
            {'med_id': 1, 'quantity': 10}, 
            {'med_id': 2, 'quantity': 10},
            {'med_id': 3, 'quantity': 10},
            {'med_id': 4, 'quantity': 10},
            {'med_id': 5, 'quantity': 10},
            {'med_id': 6, 'quantity': 10},

            ], 85201)
        create_function(conn)
        print("=========================================Optimized reserve order items by solving N+1 problem =========================================")
        optimized_reserve_order_items(conn.cursor(), 1, [
            {'med_id': 1, 'quantity': 10}, 
            {'med_id': 2, 'quantity': 10},
            {'med_id': 3, 'quantity': 10},
            {'med_id': 4, 'quantity': 10},
